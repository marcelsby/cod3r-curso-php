<nav class="modulos">
    <div class="modulo laranja">
        ...
        <ul>
            <li><a href="exercicio.php?dir=db&file=criar_schema">Criar Schema</a></li>
    ...
    <div class="modulo azul">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=api&file=upload_arquivo">Upload de Arquivo</a></li>
            <li><a href="exercicio.php?dir=api&file=download_arquivo">Download de Arquivo</a></li>
            <li><a href="exercicio.php?dir=api&file=desafio_imagens">Desafio Imagens</a></li>
        </ul>
    </div>
    <div class="modulo vermelha">
        <h3>12. Sessão</h3>
        <ul>
            <li><a href="exercicio.php?dir=sessao&file=basico_sessao">Sessão Básico</a></li>
    ...
    <div class="modulo vermelho-escuro">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=funcoes&file=args_padroes">Argumentos Padrões</a></li>
            <li><a href="exercicio.php?dir=funcoes&file=usando_tipos">Usando Tipos</a></li>
            <li><a href="exercicio.php?dir=funcoes&file=anonimas">Anônimas</a></li>
